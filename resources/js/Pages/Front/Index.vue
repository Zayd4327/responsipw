            ...
            <div class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
                <div v-for="item in skill" :key="item.id">
                    <div class="flex items-end justify-between">
                        <h4 v-if="item && item.judul" class="font-body font-semibold uppercase text-black"> {{item.judul}} </h4>
                        <h3 v-if="item && item.konten" class="font-body text-3xl font-bold text-primary">{{ item.konten }}%</h3>
                    </div>
            ...
            <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                <div className="sm:col-span-12 lg:col-span-3">
                    ...
                    <div className="text-sm text-gray-600">
                        <img src="img/logo_Web.png" class="h-8 mr-3" alt=" Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Abdul Fatah</span>
                    </div>
                </div>
